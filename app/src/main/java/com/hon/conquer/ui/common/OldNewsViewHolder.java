...
class OldNewsViewHolder extends BaseViewHolder<ZhihuDailyNewsDetail> {
    ...
    private OldNewsAdapter.OnItemClickListener mOnItemClickListener;

    OldNewsViewHolder(ViewGroup parent, Fragment fragment, OldNewsAdapter.OnItemClickListener listener) {
